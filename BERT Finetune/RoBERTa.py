...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        summary = self.data.iloc[idx]['news']
...
test_results = pd.DataFrame({'headline': test_data['headline'], 'news': test_data['news'], 'label': test_labels, 'Prediction': test_preds})
test_results.to_csv('test_test_predictions.csv', index=False)
